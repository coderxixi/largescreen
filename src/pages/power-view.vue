<template>
    <main class="screen-bg">
        ...
        <!-- 右边 -->
        <div class="right-top">
            <right-top-panel :percentage="powerData.chargingTop4.totalPercentage" :panelItems="powerData.chargingTop4.data" />
        </div>
...
import cneterSvg from '@/components/center-svg.vue';
