<template>
  <svg id="yichang" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="456" height="127"
    viewBox="0 0 456 127">
    <defs>
    ...
    <template v-for="(item, index) in dots">
      <circle class="hy-cls-3" cx="0" cy="0" :r="item.value">
        <animateMotion rotate="auto" :dur="item.dur" :begin="item.begin" repeatCount="indefinite">
